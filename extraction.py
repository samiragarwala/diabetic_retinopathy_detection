...
def arff_to_numpy() :
	...
	train_label = data[0:920,19]
	test_feature=data[920:1152,0:18]
	test_label=data[920:1152,19]
	np.save('train_feature', data, allow_pickle=True, fix_imports=True)
	np.save('train_label', data, allow_pickle=True, fix_imports=True)
	np.save('test_feature', data, allow_pickle=True, fix_imports=True)
	np.save('test_label', data, allow_pickle=True, fix_imports=True)
